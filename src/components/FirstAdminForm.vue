    ...
    <div class="first-admin-card">
      <div class="first-admin-header">
        <div class="logo page-icon">
          <img :src="'https://res.cloudinary.com/dt2jraprb/image/upload/w_150/v1760222828/ChatGPT_Image_12_oct_2025_00_46_39_uustfa.webp'" alt="Gon Homes" />
        </div>
        <h1>Welcome to<br />Gon Homes Admin</h1>
